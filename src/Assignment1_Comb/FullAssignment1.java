...
public class FullAssignment1 {
    public static void run() {
        ...
        System.out.println("  The function will write 12 squares to file SquarePatterns.out in data folder.");
        System.out.println("  Also it will print example of pattern 5 to console.");

        System.out.println();
        System.out.println("Task 0: String Length.");
        ITask task0 = new StringLength();
        MyTester tester0 = new MyTester(task0, "/home/andrey/IdeaProjects/AlgorithmsOTUS/data/1_data_tickets/0.String");
        tester0.RunTests();

        System.out.println();
        System.out.println("Task 1: Tickets.");
        ITask task1 = new HappyTickets();
        MyTester tester1 = new MyTester(task1, "/home/andrey/IdeaProjects/AlgorithmsOTUS/data/1_data_tickets/1.Tickets");
        tester1.RunTests();
        ...
        for (int i=1; i<=12; i++) {
            SquarePattern.writeSquarePatternToFile(i,
                    "/home/andrey/IdeaProjects/AlgorithmsOTUS/data/1_data_tickets/SquarePatterns.out");
        }
